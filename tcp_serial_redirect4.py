        ...
        while self.alive:
            try:
                ...
                if self.banderasocket2 == 0:      
                    ...
                    time.sleep(self.rts_pre)
                    self.serial.write(data)                 # get a bunch of bytes and send them
                    time.sleep(self.rts_pos)
...
""")
    ...
    group.add_option("--rtspre",
        ...
        action = "store",
        type = 'int',
        help = "set delay time  for PTT (prev RTS)(possible values: 0 a 30ms)",
        default = 30
    )
    ...
    group.add_option("--rtspos",
        ...
        action = "store",
        type = 'int',
        help = "set delay time for soft carrier dekey (pos RTS)(possible values: 0 to 200ms)",
        default = 100
    )
    group.add_option("--noresp",
        ...
        action = "store",
        type = 'int',
        help = "set time to wait response(possible values: 0 to 30sec.)",
        default = 5
    )
